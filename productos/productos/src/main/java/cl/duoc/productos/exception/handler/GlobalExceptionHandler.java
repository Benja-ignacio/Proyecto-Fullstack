package cl.duoc.productos.exception.handler;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>> productNotFound(ProductNotFoundException ex) {
        ...
        logger.warn("Producto no encontrado: {}", ex.getMessage()); // LOGS QUE SOLO SE PUEDE VER INTERNAMENTE
    ...
    public ResponseEntity<Map<String, String>> productAlreadyExitxs(ProductAlreadyExistsException ex) {

        logger.warn("Producto duplicado: {}", ex.getMessage()); // LOGS QUE SOLO SE PUEDE VER INTERNAMENTE
