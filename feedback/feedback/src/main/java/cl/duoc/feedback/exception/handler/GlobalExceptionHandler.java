package cl.duoc.feedback.exception.handler;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>> productNotFound(FeedbackAlreadyExistsException ex) {
    ...
    public ResponseEntity<Map<String, String>> productNotFound(FeedbackNotFoundException ex) {

        logger.warn("Feedback no encontrado: {}", ex.getMessage()); // LOGS QUE SOLO SE PUEDE VER INTERNAMENTE
