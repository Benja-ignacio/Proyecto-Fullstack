package cl.duoc.logistica.exception.handler;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>> validExceptions(MethodArgumentNotValidException ex) {
        ...
        @ExceptionHandler(LogisticNotFoundException.class) 
    public ResponseEntity<Map<String, String>> logisticNotFound(LogisticNotFoundException ex) {

        logger.warn("Logistica no encontrada: {}", ex.getMessage()); // LOGS QUE SOLO SE PUEDE VER INTERNAMENTE
